...
# Ejercicio 5 - Personas que se encuentran recuperados

num_personas = datosCovid[datosCovid['Recuperado'] == 'Recuperado'].index.size
print("-------------------")
print("El numero de personas recuperadas es de: {}".format(num_personas))
print("-------------------")