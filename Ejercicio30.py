...
# Ejercicio 30 - Cantidad de fallecidos por edad; de mayor a menor, en Colombia

fal = datosCovid[datosCovid['Estado'] == 'Fallecido'].groupby('Edad')
edad = fal.size().sort_values(ascending=False)
print("-------------------")
print("El numero de personas fallecidas por edad es de: {}".format(edad))
print("-------------------")
