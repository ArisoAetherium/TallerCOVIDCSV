...
# Ejercicio 4 -  personas que se encuentran en atención en casa

num_personas = datosCovid[datosCovid['Ubicación del caso'] == 'Casa'].index.size
print("-------------------")
print("El numero de personas que estan en casa es: {}".format(num_personas))
print("-------------------")