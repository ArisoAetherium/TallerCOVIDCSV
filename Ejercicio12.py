...
# Ejercicio 12 - Mayor a menor los 10 departamentos con mas casos de fallecidos

fallecidos = datosCovid[datosCovid['Estado'] == 'Fallecido']
fall_dep = fallecidos.groupby('Nombre departamento').size()
fall_dep_ord = fall_dep.sort_values(ascending=False).head(10)
print("-------------------")
print("Los 10 departamentos con mas fallecidos: {}".format(dep_cont))
print("-------------------")
