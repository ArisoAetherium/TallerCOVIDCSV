...
# Ejercicio 13 - Mayor a menor los 10 departamentos con mas casos de recuperados

rec = datosCovid[datosCovid['Estado'] == 'Recuperado']
rec_dep = fallecidos.groupby('Nombre departamento').size()
rec_dep_ord = fall_dep.sort_values(ascending=False).head(10)
print("-------------------")
print("Los 10 departamentos con mas Recuperados: {}".format(dep_cont))
print("-------------------")
