...
# Ejercicio 19 - Liste el promedio de edad de contagiados por hombre y mujeres por ciudad por departamento

dat = datosCovid.groupby(['Nombre departamento', 'Nombre municipio', 'Sexo'])
