...
# Ejercicio 34 - Gráfico de barras por tipo de toda Colombia

titulo = "Grafico de barras de tipo en colombia"
graf = datosCovid.groupby('Tipo de contagio').size().plot(kind='bar', title=titulo)
print("-------------------")
