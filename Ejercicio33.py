...
# Ejercicio 33 - Gráfico de barras por Sexo de toda Colombia

titulo = "Grafico de barras de sexo en colombia"
graf = datosCovid.groupby('Sexo').size().plot(kind='bar', title=titulo)
print("-------------------")
print("El gráfico de barras por sexo de toda Colombia")
plt.show()
print("-------------------")
