...
# Ejercicio 22 -  tasa de mortalidad y recuperación que tiene toda Colombia

canti = datosCovid.groupby('Estado').size()
mor = ((canti / canti.sum()) * 100)['Fallecido']
canti = datosCovid.groupby('Recuperado').size()
Rec = ((canti / canti.sum()) * 100)['Recuperado']
print("-------------------")
print("tasa de mortalidad {}, recuperación {} de Colombia".format(mor, Rec))
print("-------------------")
