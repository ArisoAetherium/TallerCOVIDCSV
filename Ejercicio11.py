...
# Ejercicio 11 - Mayor a menor los 10 departamentos con mas casos de contagiados

datos_agrupados = datosCovid.groupby('Nombre departamento')
dep_cont = datos_agrupados.size().sort_values(ascending=False).head(10)
print("-------------------")
print("Los 10 departamentos mas afectados: {}".format(dep_cont))
print("-------------------")
