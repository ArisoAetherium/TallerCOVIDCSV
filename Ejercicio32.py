...
# Ejercicio 32 - Gráfico de barras por atención de toda Colombia

titulo = "Grafico de barras de atencion en colombia"
grafico = datosCovid.groupby('Ubicación del caso').size().plot(kind='bar', title=titulo)
print("-------------------")
print("El gráfico de barras por atención de toda Colombia {}")
print("-------------------")
plt.show()
