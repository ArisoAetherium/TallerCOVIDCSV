...
# Ejercicio 6 - Personas que han fallecido

num_personas = datosCovid[datosCovid['Estado'] == 'Fallecido'].index.size
print("-------------------")
print("El numero de personas fallecidas es de: {}".format(num_personas))
print("-------------------")