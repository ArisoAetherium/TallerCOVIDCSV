...
# Ejercicio 31 - Porcentaje de personas por atención de toda Colombia

canti = datosCovid.groupby('Ubicación del caso').size()
por = round((canti / canti.sum()) * 100)
print("-------------------")
print("El porcentaje de personas por atención de colombia: {}".format(por))
print("-------------------")
