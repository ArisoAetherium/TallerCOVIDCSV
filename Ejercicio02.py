...
# Ejercicio 2 - Municipios Afectados

num_municipio = datosCovid['Nombre municipio'].unique().size
print("-------------------")
print("La cantidad de municipios afectados es de: {}".format(num_municipio))
print("-------------------")